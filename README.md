...
Get the package source:
    ...
    $ go get github.com/unix-world/kinesis-consumer

Note: This repo now requires the AWS SDK V2 package. If you are still using
AWS SDK V1 then use: https://github.com/unix-world/kinesis-consumer/releases/tag/v0.3.5
...
import(
	...
	consumer "github.com/unix-world/kinesis-consumer"
)
...
```go
import store "github.com/unix-world/kinesis-consumer/store/redis"
...
```go
import store "github.com/unix-world/kinesis-consumer/store/ddb"
...
```go
import store "github.com/unix-world/kinesis-consumer/store/postgres"
...
```go
import store "github.com/unix-world/kinesis-consumer/store/mysql"
...
[contributors]: https://github.com/unix-world/kinesis-connectors/graphs/contributors
